...
setTimeout(() => {
	...
	global.table_window = veWindow({
		table: new ve.Table([[["Test","hello",1,7,"Row 1"],["","world",2,8,"Row 2"],["","this",3,9,"Row 3"],["","is",4,10,"Row 4"],["","a",5,11,"Row 5"],["","test",6,12,"Row 6"],["","",7,"",""]]], { dark_mode: true, name: "Test Spreadsheet" })
	});
}, 500);