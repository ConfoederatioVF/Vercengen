	...
	async setTheme(arg0_theme_name) {
		...
		try {
			...
			if (fs.existsSync(file_path)) {
				...
				let theme_id = Math.randomNumber(0, 10000000); //[WIP] - Refactor component
				
				monaco.editor.defineTheme(`custom-theme-${theme_id}`, theme_data);
				monaco.editor.setTheme(`custom-theme-${theme_id}`);
			} else {
